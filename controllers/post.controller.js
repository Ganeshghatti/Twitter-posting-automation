...
const postTweet = async (oauth, consumerKey, consumerSecret, accessToken, accessTokenSecret, text) => {
  return await postTweetDirect(oauth, consumerKey, consumerSecret, accessToken, accessTokenSecret, text);
};
